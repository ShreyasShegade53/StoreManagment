...
import com.techvg.store.domain.Employee;
import com.techvg.store.repository.EmployeeRepository;
...
/**
 * REST controller for managing {@link com.techvg.store.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
@Transactional
